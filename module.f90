module var2
    ...
    implicit none
    save
    integer, parameter :: im = 48, jm = 48, km = 48, nThreads = 24,   &
                          m1_max = 2000, m2_max = 100, nmax = 3

    logical, parameter ::                       &
                 bubble             = .true.,   &
                 DragForceOutput    = .false.,  &
    ...
    character(len=10), parameter ::         &
                ...
                artCompresMethod =  'auto', &   ! Select between modified or automatic
                                                ...
                                                ! 'modified' = allows to select time and
                                                !              universal speed of sound
                                                ! 'auto'     = automatically select 
                                                !              appropriate conditions

                FlowCondPreset   = 'Stokes'     ! Select boundary and flow conditions based
                                                ! based on the preset:
